...
# define PINS_READ_PCD8544_DIN		PIND
# define PINS_WRITE_PCD8544_DIN		PORTD
# define PINS_DDR_PCD8544_DIN		DDRD
# define PINS_OFFSET_PCD8544_DIN	3

# define PINS_READ_PCD8544_CLK		PIND
# define PINS_WRITE_PCD8544_CLK		PORTD
# define PINS_DDR_PCD8544_CLK		DDRD
# define PINS_OFFSET_PCD8544_CLK	4
